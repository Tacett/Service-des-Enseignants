...
public class ChampollionJUnitTest {
    ...
    public void testAjouteEnseignement() {
        ...
        assertFalse(untel.getListeServicePrevus().isEmpty());
    }
    ...
    public void testAjouteIntervention() throws Exception {
        ...
        assertFalse(untel.getlisteInterventions().isEmpty());
    ...
    public void testHeuresPrevues() {
        ...
        untel.listeServicePrevus.add(new ServicePrevu(20, 20, 0, java, untel));
        untel.listeServicePrevus.add(new ServicePrevu(0, 20, 10, uml, untel));
    ...
    public void testHeuresPrevuesUE() {
        ...
        untel.getListeServicePrevus().add(new ServicePrevu(20, 20, 0, java, untel));
        untel.getListeServicePrevus().add(new ServicePrevu(0, 20, 10, uml, untel));
